...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\course}[1]{
	\newcommand{\thisiscourse}{#1}
}
\newcommand{\college}[1]{
	\newcommand{\thisiscollege}{#1}
}
\newcommand{\major}[1]{
	\newcommand{\thisismajor}{#1}
}
\newcommand{\studentid}[1]{
	\newcommand{\thisisstudentid}{#1}
}
\newcommand{\theauthor}[1]{
	\newcommand{\thisisauthor}{#1}
}
\newcommand{\teacher}[1]{
	\newcommand{\thisisteacher}{#1}
}
\newcommand{\thedate}[1]{
	\newcommand{\thisisdate}{#1}
}
...
\renewcommand{\maketitle}{
	\begin{titlepage}
		...
		\begin{center}
			\begin{large}
				\begin{tabular}{rl}
					\xiaoerhao{\bfseries\hei{课程名称：}}& \xiaoerhao{\bfseries\hei{\thisiscourse}}\\
					\\
					\xiaoerhao{\bfseries\hei{学\qquad 院：}}& \xiaoerhao{\bfseries\hei{\thisiscollege}}\\
					\\
					\xiaoerhao{\bfseries\hei{专\qquad 业：}}& \xiaoerhao{\bfseries\hei{\thisismajor}}\\
					\\
					\xiaoerhao{\bfseries\hei{学\qquad 号：}}& \xiaoerhao{\bfseries\hei{\thisisstudentid}}\\
					\\
					\xiaoerhao{\bfseries\hei{姓\qquad 名：}}& \xiaoerhao{\bfseries\hei{\thisisauthor}}\\
					\\
					\xiaoerhao{\bfseries\hei{指导教师：}}& \xiaoerhao{\bfseries\hei{\thisisteacher}}\\
					\\
					\xiaoerhao{\bfseries\hei{日\qquad 期：}}& \xiaoerhao{\bfseries\hei{\thisisdate}}\\
				\end{tabular}
			\end{large}
		\end{center}
	\end{titlepage}
